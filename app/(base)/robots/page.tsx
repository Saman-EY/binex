        ...
        <>
            <div className="container lg:mx-auto mx-4">
                <div className="flex items-center justify-center mb-2 py-4 bg-white z-10 lg:-mx-8 sm:-mx-4 -mx-2">
                      <span className="text-black lg:text-3xl text-xl font-bold  ">
                      {"ربات‌های باینکس"}
                      </span>
                </div>
                    ...
                    {robots.map((item, i) => {
                        return (
                            <div className="col-span-3 lg:col-span-1" key={i}>
                                ...
                                <div
                                    className="bg-white rounded-2xl px-4 lg:py-8 py-4 gap-4 shadow-binex flex flex-col border border-transparent  hover:border-blue-light transition-all">
                                    <ProfileRobot
                                        name={item.name}
