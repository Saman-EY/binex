    ...
    <div className="container lg:mx-auto px-4  flex flex-col items-center justify-center gap-4 my-4">
        ...
        <div className="gap-10 flex flex-col">
            <div className="gap-4">
                ...
                .در معنای لغوی، منابع انسانی  به تمامی نیروهای کار یک مجموعه یا سازمان گفته می‌شود. در دنیای حرفه‌ای اما، منابع انسانی که به آن مدیریت منابع انسانی  هم گفته می‌شود، بخش یا واحدی از یک کسب و کار است که مسئول رسیدگی و رفع نیازهای کارکنان در جهت بهره‌وری بیشتر نیز هست. 
                <br />
