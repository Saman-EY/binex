    ...
    <div className="container lg:mx-auto px-4 ">
      <div className="flex flex-col gap-4 ">
        <div className="flex flex-row items-center lg:mt-8 mt-4">
          <Image className="lg:block hidden" src="/img/icone/binex-robot.png" alt="binex Logo" width={58} height={78} />
          <div className="flex flex-col lg:items-start lg:justify-start items-center justify-center gap-2 w-full">
            <Caption className="text-black font-bold lg:text-2xl text-xl">{"اطلاعات ربات"}</Caption>
