  ...
  return (
    <>
      <div className="flex flex-col items-center w-full gap-8 max-w-[500px] mx-auto justify-center lg:pt-[15%]">
        <LoginSignupHeader title={is_edit ? "اصلاح ایمیل" : "ورود به داشبورد"} />
        {/* step 1 */}
        <div className=" flex-col gap-4 w-full flex">
          ...
          <form action="" className="w-full">
            <div className="mb-4">
              <LoginInput label="ایمیل خود را وارد نمایید" dir="ltr"></LoginInput>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <NotAccount title="حساب کاربری ندارید؟">
                <Link href={routes.auth.registerFree} className="text-xs lg:text-sm text-blue-light font-semibold">
                  ثبت نام
                </Link>
              </NotAccount>
            </div>
