    ...
    return (<>
        <div className="flex items-center justify-between lg:flex-row flex-col gap-5">
            <div className="grid grid-cols-1 lg:grid-cols-3 items-center lg:flex-row flex-col gap-6 w-full">
                <div className="col-span-1"><DashboardSelect placeholder="رمزارز"  options={[
                    {title: "BTC", icon: '/img/cryptocurrency/3.svg'},
                    {title: "ETH", icon: '/img/cryptocurrency/ETH.svg'},
                ]} /></div>
                <div className="col-span-1"><Select className="text-gray800 text-sm text-nowrap " label="تاریخ شروع:"></Select></div>
                <div className="col-span-1"><Select className="text-gray800 text-sm text-nowrap " label="تاریخ پایان:"></Select></div>
            </div>
