                ...
                <table className="table border-spacing-y-2 border-separate">
                    ...
                    <thead>
                        <tr className="text-center border-b-0  ">
                            <th className="text-dark text-base font-medium bg-head-table-color py-4 rounded-r-xl">
                                نماد
                            </th>
                            <th className="text-dark text-base font-medium bg-head-table-color py-4">
                                نام ارز
                            </th>
                            <th className="text-dark text-base font-medium bg-head-table-color py-4">
                                تایم فریم
                            ...
                            <th className="text-dark text-base font-medium bg-head-table-color py-4 rounded-l-xl">
                                صفحه اختصاصی
                            </th>
                        </tr>
                    </thead>
                        ...
                        {Array.from({ length: 10 }).map((item, idx) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td>
                                        <NameCryptocurrency parentClassName="flex-row items-center justify-center">
                                            <Link
                                                ...
                                                className="text-base text-gray900 font-semibold"
                                            >
                                                {"BTC"}
                                            </Link>
                                    ...
                                    <td>
                                        <TimeFrame className="text-sm text-dark">
                                            {"1h"}
                                        </TimeFrame>
                                    </td>
                                    <td>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-end justify-end ">
                                <div className="flex items-center">
                                    <TimeFrame className="text-sm text-dark font-semibold">
                                        {"1h"}
                                    </TimeFrame>
                                    <UpDownBtn
                                        showIcon
                                ...
                                <div className="mt-1">
                                    <RobotName parentClassName="">
                                        ...
                                        <span className="text-blue-light-2 text-xxs ms-1">
                                            {"(Astra) "}
                                        </span>
                                    </RobotName>
                                </div>
