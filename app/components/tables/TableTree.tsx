    ...
    <div className="lg:my-4">
        ...
        <table className="table border-spacing-y-2 border-separate">
          ...
          <thead className="relative">
            <tr className="text-center border-b-0  ">
              <th className="text-gray900 text-sm font-medium bg-[#c6d9dc] py-4 rounded-r-xl">نماد و نام ارز</th>
              <th className="text-gray900 text-sm font-medium bg-[#c6d9dc] py-4"> تاریخ</th>
              <th className="text-gray900 text-sm font-medium bg-[#c6d9dc] py-4"> قیمت آغازین</th>
              <th className="text-gray900 text-sm font-medium bg-[#c6d9dc] py-4">قیمت پایانی</th>
              <th className="text-gray900 text-sm font-medium bg-[#c6d9dc] py-4"> پوزیشن</th>
              <th className="text-gray900 text-sm font-medium bg-[#c6d9dc] py-4 rounded-l-xl"> درصد سود و زیان‌</th>
            </tr>
      ...
      <div className="lg:hidden block overflow-auto">
        <table className="table border-spacing-y-2 border-separate">
          ...
          <thead className="relative">
            <tr className="text-center border-b-0   ">
              <th className="whitespace-nowrap  text-gray900 text-xs font-medium bg-[#c6d9dc]  py-3 px-0 rounded-r-xl">
                نام ارز
              </th>
              <th className="whitespace-nowrap  text-gray900 text-xs font-medium bg-[#c6d9dc]  py-3 px-0">تاریخ</th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-[#c6d9dc]  py-3 px-0">
                قیمت آغازین
              </th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-[#c6d9dc]  py-3 px-2">
                قیمت پایانی
              </th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-[#c6d9dc]  py-3 px-0">پوزیشن</th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-[#c6d9dc]  py-3 px-0 rounded-l-xl">
                سود و زیان‌
              </th>
            </tr>
          ...
          <thead>
            <tr className="text-center border-b-0   ">
              <th className="whitespace-nowrap  text-gray900 text-xs font-medium bg-head-table-color py-3 px-0 rounded-r-xl">
                نام ارز
              </th>
              <th className="whitespace-nowrap  text-gray900 text-xs font-medium bg-head-table-color py-3 px-0">
                تاریخ
              </th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-head-table-color py-3 px-0">
                قیمت آغازین
              </th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-head-table-color py-3 px-2">
                قیمت پایانی
              </th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-head-table-color py-3 px-0">
                پوزیشن
              </th>
              <th className="whitespace-nowrap   text-gray900 text-xs font-medium bg-head-table-color py-3 px-0 rounded-l-xl">
                سود و زیان‌
              </th>
            </tr>
          </thead>
