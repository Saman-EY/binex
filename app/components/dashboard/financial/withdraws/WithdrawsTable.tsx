                    ...
                    <tbody>
                        ...
                        <tr className="border-b-0">
                            ...
                            <td className="text-center bg-white100 rounded-l-2xl">
                                <UpDownBtn className="text-nowrap text-sm px-6 py-2 bg-up">{"تایید شده"}</UpDownBtn>
                            </td>
                        </tr>
                        {/* row 2 */}
                        <tr className="border-b-0">
                            ...
                            <td className="text-center bg-white100 rounded-l-2xl">
                                <UpDownBtn className="text-nowrap text-sm bg-down px-6 py-2">{"لغو شده"}</UpDownBtn>
                            </td>
                        </tr>
                    </tbody>
                </table>
