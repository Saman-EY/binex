        ...
        <>
            ...
            >
                ...
                >
                    <i
                        className={cn(
                            "text-black  transition scale-[1.6]",
                            open && "rotate-180"
                        )}
                    >
                        <ChevronDownIcon />
                        ...
                        >
                            ...
                            <NameCryptocurrency parentClassName="flex-col items-end">
                                <span className="text-[18px] text-dark-black font-semibold">
                                    {order.currency.name_fa}
                                </span>
                                <span className="text-gray800 text-xs  mt-1">
                                    {order.currency.name}
                                </span>
                            </NameCryptocurrency>
                        </Link>
                        ...
                        >
                            <TextInfo parentClassName="flex-row items-center justify-center">
                                <span className="text-xs text-gray900">
                                    {p2e(order.date.toLocaleDateString("fa"))}
                                </span>
                                <span className="text-gray800 text-xs ms-1">
                                    ({p2e(order.date.toLocaleTimeString("fa"))})
                                </span>
                            </TextInfo>
                        </ProfitLossContent>
                    </div>
                ...
                <div className="flex items-center justify-between flex-col w-full p-3 pt-22">
                    <div className="w-full ">
                        ...
                        >
                            <TextInfo parentClassName="flex-row items-center justify-center gap-[2px]">
                                <span
                                    className="text-xs text-gray900 font-bold"
                                    dir="ltr"
                                >
                                    {order.start_price}
                                </span>
