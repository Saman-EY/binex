            ...
            <div className="rounded-2xl border border-head-table-color lg:p-8 p-4 bg-white flex flex-col gap-4">
                <div className="flex items-center justify-between lg:flex-row flex-col gap-4">
                    ...
                    <div className="~lg:w-full">
                        <Modal
                            button={
                                <ButtonStopActivate
                                    className="bg-down px-2 !py-2 text-sm rounded-xl"
                                    amount="توقف ربات"
                                >
                                    {" "}
                                    <i>
                            ...
                            closer={
                                <ButtonBinex
                                    className={
                                        "!bg-transparent text-binex-color border border-binex-color"
                                    }
                                >
                                    خیر
                                </ButtonBinex>
                        ...
                        >
                            با تایید توقف ربات، تمام فعالیت ها و معاملات ربات X
                            متوقف خواهد شد. آیا مطمئن هستید؟
                        </Modal>
                    </div>
                </div>
                <div className="flex flex-col">
                    ...
                    >
                        <div className="flex lg:flex-row items-center lg:justify-end ">
                            <TextInfo parentClassName="flex-row items-center justify-end gap-1 !mx-0">
                                <span className="text-sm font-bold text-gray900">
                                    {"145,145,541"}
                                </span>
                    ...
                    >
                        <div className="flex lg:flex-row items-center lg:justify-end ">
                            <TextInfo parentClassName="flex-row items-center justify-end  !mx-0">
                                <span className="text-gray900 text-sm  font-bold">
                                    {"50"}
                                </span>
                            </TextInfo>
                        </div>
                    ...
                    >
                        <div className="flex lg:flex-row items-center lg:justify-end ">
                            <TextInfo parentClassName="flex-row items-center justify-end  !mx-0">
                                <span className="text-green100 text-sm  font-bold">
                                    {"30%"}
                                </span>
                            </TextInfo>
                        </div>
                    ...
                    >
                        <div className="flex lg:flex-row items-center lg:justify-end ">
                            <TextInfo parentClassName="flex-row items-center justify-end  !mx-0">
                                <span className="text-down text-sm  font-bold">
                                    {"10%"}
                                </span>
                            </TextInfo>
                        </div>
