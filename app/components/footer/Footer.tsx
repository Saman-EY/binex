              ...
              <div className="grid grid-cols-2 gap-3 items-end">
                <div className="lg:col-span-1 col-span-2">
                  <div className="flex flex-col items-center lg:items-start">
                    <span className="lg:text-xl text-base lg:text-white text-blue mb-5 ">
                      دسترسی‌های باینکس
                    </span>
                ...
                <div className="lg:col-span-1 col-span-2">
                  <div className="lg:mt-14 mt-8 flex lg:flex-row flex-col gap-10 items-center justify-between flex-wrap xl:flex-nowrap">
                    <div className="flex items-center lg:flex-row flex-col">
                      ...
                      <Link
                        href="#"
                        className="text-white text-sm lg:ms-4 mt-4 hover:text-blue transition-all lg:mt-0"
                      >
                        (855) 256-2001
                      </Link>
                    </div>
