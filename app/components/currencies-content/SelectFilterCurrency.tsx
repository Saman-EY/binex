            ...
            <div className="flex items-center gap-4 lg:flex-row flex-col grow w-full">
                <div className="grid grid-cols-2 lg:grid-cols-5 items-center gap-4 w-full">
                    <div className="col-span-1">
                        <DashboardSelect placeholder={'تایم فریم'} options={[{title: '15m'}, {title: '1h'}, {title: '12h'}, {title: '1d'}]} />
                    </div>
                    <div className="col-span-1">
                        <DashboardSelect placeholder="ربات:" options={[{title: "Neuron"}, {title: "Quantom"}, {title: "Algorithm"}, {title: "Starlet"}, {title: "Infinit"}]} />
                    </div>
                    <div className="col-span-2 lg:col-span-1"><Select className="text-gray800 lg:text-sm  text-xs text-nowrap" label="تاریخ شروع:" /></div>
                    <div className="col-span-2 lg:col-span-1"><Select className="text-gray800 lg:text-sm  text-xs text-nowrap" label="تاریخ پایان:" /></div>
