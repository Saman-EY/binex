                    ...
                    <div className="grid grid-cols-2 gap-6 items-end">
                        <div className="lg:col-span-1 col-span-2">
                            <div className="flex flex-col gap-4">
                                <div className="">
                                    <DashboardInput label='عنوان: ' placeholder='' className=''
                                                    classNameLabel='text-sm' extraText=''
                                                    classNameText=''></DashboardInput>
                                </div>
                            </div>
                        </div>
                        <div className="lg:col-span-1 col-span-2">
                            <DashboardSelect label='دسته بندی' classNameLabel='text-sm text-gray800' options={[
                                {title: "فنی"},
                                {title: "مالی"},
                            ]}/>
                        </div>
                        <div className="col-span-2">
                            <div className="flex items-start justify-start gap-2 flex-col">
                                ...
                                <textarea className="textarea bg-white200 w-full h-[100px] overflow-y-scroll"
                                          placeholder="Bio" rows={4}></textarea>
                            </div>
